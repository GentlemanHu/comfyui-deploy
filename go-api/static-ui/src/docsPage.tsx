...
const endpoints: EndpointDoc[] = [
  { method: "POST", path: "/api/run", auth: "Bearer API Key", purpose: "Create a workflow run from deployment_id, or manually from workflow_version_id + machine_id.", request: `{"deployment_id":"uuid","inputs":{}} or {"workflow_version_id":"uuid","machine_id":"uuid","inputs":{},"run_origin":"manual"}`, response: `{"run_id":"uuid"}` },
